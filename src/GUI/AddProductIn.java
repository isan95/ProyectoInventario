...
public class AddProductIn extends javax.swing.JDialog {
     ...
     */
    public AddProductIn(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTableAddProduct.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Codigo", "Nombre", "Descripción", "Precio", "Unidad de medida"
            }
        ) {
    ...
    private void jTextSearchProductAddKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextSearchProductAddKeyTyped
        ...
        try {
            java.sql.ResultSet rsp = qp.getProductsIn(attribute, jTextSearchProductAdd.getText());
    ...
    private void jButtonAddProductActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAddProductActionPerformed
       ...
       values = new String[model.getColumnCount()+1];
       values[model.getColumnCount()] = "1";
       if(row>=0){
           for(int i=0;i<model.getColumnCount();i++){
               values[i] =  model.getValueAt(row, i).toString();
           }
        HomeUser.getModelProductIn().addRow(values);
       }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddProductIn.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                AddProductIn dialog = new AddProductIn(new javax.swing.JFrame(), true);
